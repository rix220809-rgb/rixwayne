...
const CACHE_NAME = "our-memories-v10.5.3";
const CORE = [
  "./",
  "./index.html",
  "./manifest.json",
  "./data/special_events.json?v=10.5.3",
  "./data/daily_question_bank.json?v=10.5.3",
  "./css/style.css?v=10.5.3",
  "./js/app.js?v=10.5.3",
  "./js/cycle-engine.js?v=10.5.3",
  "./js/push-notifications.js?v=10.5.3",
  "./icon-192.png",
  "./icon-512.png"
];
