...
const CACHE_NAME = "our-memories-v10.5.2";
const CORE = [
  "./",
  "./index.html",
  "./manifest.json",
  "./data/special_events.json?v=10.5.2",
  "./data/daily_question_bank.json?v=10.5.2",
  "./css/style.css?v=10.5.2",
  "./js/app.js?v=10.5.2",
  "./js/cycle-engine.js?v=10.5.2",
  "./js/push-notifications.js?v=10.5.2",
  "./icon-192.png",
  "./icon-512.png"
];
